...
export default function Timeline({ navigateTab }) {
  const { events } = useObservatoryStore()
  ...
  return (
    <div style={{ display: 'flex', height: '100%' }}>
      <div style={{
        ...
        <div style={{ color: '#555', fontSize: 10, marginBottom: 8, letterSpacing: 1 }}>FILTER BY TYPE</div>
        <button
