    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span className="ec-font-label" style={{ fontSize: 11, letterSpacing: 2, color: 'var(--ec-accent-luna)' }}>NEW COLLECTION</span>
          <div style={{ flex: 1 }} />
        ...
        <div style={{ padding: 18, display: 'flex', flexDirection: 'column', gap: 12 }}>
          {[
            ...
            <div key={f.label}>
              <div className="ec-font-label" style={{ fontSize: 7, letterSpacing: 1.5, color: 'var(--ec-text-muted)', marginBottom: 4 }}>{f.label}</div>
              <input value={f.val} onChange={e => f.set(e.target.value)} placeholder={f.ph} style={{
                ...
                fontFamily: f.mono ? "'JetBrains Mono','SF Mono',monospace" : "'DM Sans',system-ui,sans-serif",
                outline: 'none',
              }} />
            </div>
          ))}
          ...
          <div style={{
            fontSize: 8, color: 'var(--ec-text-muted)', fontStyle: 'italic',
          ...
          }} className="ec-font-label">CREATE</div>
        </div>
      </div>
    </div>
  );
