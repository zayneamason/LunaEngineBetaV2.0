...
Event Bus:
  ...
  CC should wire these to WebSocket broadcasts on the KOZMO routes.
...
class EventSink(Protocol):
    """Interface for event consumers. CC implements this."""
...
class TimelineService:
    ...
    CC: Wire this into the KOZMO API routes. Each route handler:
