...
Author: Architecture handoff — not production code yet
Version: 2.0.0
...
class CameraMetadata(BaseModel):
    ...
    # TODO(cc): Add film_stock, color_science, sensor_size from Studio proto
...
class EffectNode(BaseModel):
    ...
    # TODO(cc): plugin_type will need a registry/validator eventually.
    # For now it's a free string. Don't hardcode type checks against it.
    """
