...
2. **Hooks-Based API Layer** - Three custom hooks (`useLunaAPI`, `useChat`, `useVoice`)
...
5. **Polling for Status** - 2-second intervals for engine health and consciousness
...
| Rank | Component | Lines |
|------|-----------|-------|
| 1 | TuningPanel | 814 |
| 2 | PersonalityMonitorPanel | 553 |
| 3 | VoicePanel | 432 |
| 4 | ContextDebugPanel | 282 |
| 5 | App.jsx | 274 |
| 6 | EngineStatus | 238 |
| 7 | ConversationCache | 182 |
| 8 | ThoughtStream | 171 |
| 9 | ChatPanel | 158 |
| 10 | ConsciousnessMonitor | 126 |
| 11 | GlassCard | 30 |
| 12 | StatusDot | 25 |
| 13 | GradientOrb | 14 |
