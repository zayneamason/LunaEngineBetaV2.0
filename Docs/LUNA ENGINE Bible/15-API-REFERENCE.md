...
|----------|-------|-------------|
| Core Interaction | 6 | Message sending, streaming, abort, interrupt, thoughts |
| Engine Status | 4 | Health, status, history, consciousness |
| Memory | 6 | Node CRUD, access, reinforce, stats |
