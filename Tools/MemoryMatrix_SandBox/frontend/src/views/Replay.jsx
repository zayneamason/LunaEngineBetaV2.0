...
export default function Replay() {
  const { replayResult, replayPhaseIndex, runReplay, setReplayPhase, clearReplay } = useStore()
    ...
    <div style={{ display: 'flex', height: '100%' }}>
      ...
      <div style={{
        ...
        {replayResult && replayResult.phases && (
          <>
            <div style={{ color: '#555', fontSize: 10, letterSpacing: 1, marginTop: 8 }}>
              PHASES
            </div>
...
function PhaseDetail({ phase }) {
  ...
  return (
    <div>
      ...
      {/* Token budget bar (assembly phase) */}
