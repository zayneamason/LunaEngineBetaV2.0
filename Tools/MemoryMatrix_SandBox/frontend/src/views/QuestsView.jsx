...
const ENTITY_TYPES = {
  ...
  place: { color: '#34d399' },
  project: { color: '#67e8f9' },
}

export default function QuestsView() {
  const { quests, selectedQuestId, selectQuest, fetchQuests, acceptQuest, runMaintenanceSweep } = useStore()
              ...
              >
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ color: config.color, fontSize: 13, fontWeight: 600, marginBottom: 2 }}>
                      {quest.title}
                    </div>
                    {quest.subtitle && (
                      <div style={{
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 16, marginBottom: 24 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ color: config.color, fontSize: 18, fontWeight: 700, marginBottom: 4 }}>
            {quest.title}
          </div>
          {quest.subtitle && (
            <div style={{
        ...
        <div style={{
          ...
          {Object.entries(investigation).map(([key, value]) => (
            <div key={key} style={{
              ...
              <div style={{ color: '#7dd3fc', fontSize: 18, fontWeight: 700, marginBottom: 4 }}>
                {value}
              </div>
      ...
      {/* Target lock-in */}
      {quest.target_lock_in !== null && quest.target_lock_in !== undefined && (
        <div style={{
          background: '#0a0a14',
          padding: 12,
          borderRadius: 4,
          ...
          <div style={{ color: '#aaa', fontSize: 16 }}>
            {(quest.target_lock_in * 100).toFixed(1)}%
          </div>
        </div>
      )}
